...
struct CurvePoint {
	ks::vec3 curve_point_vertex;
	ks::vec2 curve_point_normal;
	ks::vec2 curve_point_uv;
};
...
struct Curve {
	...
	std::vector<ks::vec3> curve_vertices;
	std::vector<ks::vec3> curve_normals;
	std::vector<ks::vec2> curve_uvs;
	woven_t			   curve_type;
